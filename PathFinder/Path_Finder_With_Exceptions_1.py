...
assert (start_col in range(maze_size) and end_col in range(maze_size) and start_row in range(maze_size) and end_row in range(maze_size)),("Enter Start and End coordinates in the RANGE of Maze Dimensions")
