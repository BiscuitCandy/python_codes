...
if (start_col not in range(maze_col_size) or end_col not in range(maze_col_size) or start_row not in range(maze_row_size) or end_row not in range(maze_row_size)):
